<?php
  ...
  function send_mail($bedrijf, $voornaam, $achternaam, $email)
  {
    ...
    try {
        ...
        $mail->Body    = "
          ...
          Klik de link:
          <a href='http://localhost/cms-portfoliosite/account_accepteren.php?b=$bedrijf&v=$voornaam&a=$achternaam&m=$email'>Account toegang geven</a>
        ";
  ...
  function send_confirmation($bedrijf, $voornaam, $achternaam, $email)
  {
    ...
    $f = fopen('config.txt','r'); // is for the password it's in a txt file for safety measures
    while ($line = fgets($f))
    {
      $password = $line;
    }
    ...
    try {
        ...
        $mail->Body    = "
          ...
          U kunt nu een account aanmaken.
          Klik de link:
          <a href='http://localhost/cms-portfoliosite/account_maken_bedrijf.php'>Account maken</a>
        ";
